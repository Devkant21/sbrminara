...
import { IoLogoAppleAppstore, IoLocationOutline } from "react-icons/io5";
    ...
    <div className="mt-20">
      <div className="download w-full  py-16 rounded-xl">
        <div className="flex flex-col justify-center items-center space-y-5">
          ...
          <p className='flex items-center space-x-2 text-sm'><IoLocationOutline />2Q76+VP7, Seegehalli, Krishnarajapura, Bengaluru, Karnataka 560067</p>
      ...
      <footer className="w-full py-10 bg-neutral-800 text-white">
        <div className="w-11/12 md:w-1/3 m-auto flex flex-col items-center text-center space-y-5">
          <h1 className="text-2xl font-bold">SBR MINARA</h1>
          ...
          <p className="text-sm text-gray-400 p-5">SBR Group. 2023 All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
