...
const NewestDeals = () => {
    return (
        <div className='py-10'>
            ...
            <h1 className='text-4xl font-bold'>Floor Plans & Layout</h1>
            <div className="deals grid 2xl:grid-cols-5 gap-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 py-10">
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            ...
                            <div className='flex items-center space-x-1'>
                                <GiBathtub />
                                <p className='text-sm text-gray-400'>3 Bathroom</p>
                            </div>
                            <div className='flex items-center space-x-1'>
                                <GiHomeGarage />
                        ...
                        <h1 className='text-2xl font-semibold'>60L onwards</h1>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            <div className='flex items-center space-x-1'>
                                <IoBedOutline />
                                <p className='text-sm text-gray-400'>4 Bedroom</p>
                            </div>
                            <div className='flex items-center space-x-1'>
                                <GiBathtub />
                                <p className='text-sm text-gray-400'>3 Bathroom</p>
                        ...
                        <h1 className='text-2xl font-semibold'>2 CR *</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            <div className='flex items-center space-x-1'>
                                <IoBedOutline />
                                <p className='text-sm text-gray-400'>2.5 Bedroom</p>
                            </div>
                            <div className='flex items-center space-x-1'>
                                <GiBathtub />
                        ...
                        <h1 className='text-2xl font-semibold'>1.5 * CR</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            <div className='flex items-center space-x-1'>
                                <IoBedOutline />
                                <p className='text-sm text-gray-400'>5 Bedroom</p>
                            </div>
                            <div className='flex items-center space-x-1'>
                                <GiBathtub />
                                <p className='text-sm text-gray-400'>3 Bathroom</p>
                        ...
                        <h1 className='text-2xl font-semibold'>1.8* CR</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            ...
                            <div className='flex items-center space-x-1'>
                                <GiHomeGarage />
                                <p className='text-sm text-gray-400'>1 Balcony</p>
                            </div>
                        </div>
                        <h1 className='text-2xl font-semibold'>90* L</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        ...
                        <h1 className='text-2xl font-semibold'>50* L</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
                ...
                <div className="deal h-[350px] bg-white drop-shadow-2xl rounded-xl">
                    ...
                    <div className='p-4 space-y-4'>
                        <div className='flex space-x-5 items-center'>
                            <div className='flex items-center space-x-1'>
                                <IoBedOutline />
                                <p className='text-sm text-gray-400'>1 Bedroom</p>
                            </div>
                            <div className='flex items-center space-x-1'>
                                <GiBathtub />
                                <p className='text-sm text-gray-400'>3 Bathroom</p>
                        ...
                        <h1 className='text-2xl font-semibold'>80* L</h1>
                        {/* <div className='flex items-center space-x-2'>
                <IoLocationOutline/>
